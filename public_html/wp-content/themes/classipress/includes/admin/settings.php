		...
		$this->tab_sections['general']['configuration'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'desc'	 => sprintf( __( '%1$s Sign up for a free <a target="_blank" href="%2$s">Twitter account</a>.', APP_TD ), '<i class="social-ico dashicons-before fa fa-twitter"></i>', 'https://twitter.com' ),
					'type'	 => 'text',
				...
				array(
					...
					'desc'	 => sprintf( __( '%1$s Sign up for a free <a target="_blank" href="%2$s">Facebook account</a>.', APP_TD ), '<i class="social-ico dashicons-before fa fa-facebook"></i>', 'https://www.facebook.com' ),
					'type'	 => 'text',
					'name'	 => 'facebook_id',
                ...
                array(
					...
					'desc'	 => sprintf( __( '%1$s Sign up for a free <a target="_blank" href="%2$s">Vk account</a>.', APP_TD ), '<i class="social-ico dashicons-before fa fa-vk"></i>', 'https://www.vk.com' ),
					'type'	 => 'text',
					'name'	 => 'vk_id',
