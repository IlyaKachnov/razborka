		...
		$this->tab_sections['general']['configuration'] = array(
			...
			'fields' => array(
				...
				array(
					...
					'desc'	 => sprintf( __( '%1$s Sign up for a free <a target="_blank" href="%2$s">Twitter account</a>.', APP_TD ), '<i class="fa fa-twitter"></i>', 'https://twitter.com' ),
					'type'	 => 'text',
				...
				array(
					...
					'desc'	 => sprintf( __( '%1$s Sign up for a free <a target="_blank" href="%2$s">Facebook account</a>.', APP_TD ), '<i class="fa fa-facebook"></i>', 'https://www.facebook.com' ),
					'type'	 => 'text',
					'name'	 => 'facebook_id',
					'tip'	 => __( 'Display a Facebook icon in the header that links to your page.', APP_TD ),
				),
                array(
					'title'	 => __( 'Идентификатор Vk', APP_TD ),
					'desc'	 => sprintf( __( '%1$s Sign up for a free <a target="_blank" href="%2$s">Vk account</a>.', APP_TD ), '<i class="fa fa-vk"></i>', 'https://www.vk.com' ),
					'type'	 => 'text',
					'name'	 => 'vk_id',
					'tip'	 => __( 'Display a VK icon in the header that links to your page.', APP_TD ),
				),
                array(
					'title'	 => __( 'Идентификатор Instagram', APP_TD ),
					'desc'	 => sprintf( __( '%1$s Sign up for a free <a target="_blank" href="%2$s">Instagram account</a>.', APP_TD ), '<i class="fa fa-instagram"></i>', 'https://www.instagram.com' ),
					'type'	 => 'text',
					'name'	 => 'instagram_id',
					'tip'	 => __( 'Display an Instagram icon in the header that links to your page.', APP_TD ),
				),
				array(
